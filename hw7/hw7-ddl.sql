...
INSERT INTO skills ( skills_id, skills_name, skills_description, skills_tag) values
    ...
    (3, 'graphic design', 'creating visually appealing graphics', 'Skill 3'),
    (4, 'data analysis', 'analyzing and interpreting data', 'Skill 4'),
    (5, 'public speaking', 'effective communication in front of an audience', 'Skill 5'),
    (6, 'web development', 'building and maintaining websites', 'Skill 6'),
    (7, 'foreign language proficiency', 'fluent in a foreign language', 'Skill 7'),
    (8, 'project management', 'leading and organizing projects', 'Skill 8');
...
insert into people (people_id,people_last_name, people_first_name, people_date_joined) values 
    (1, 'Person 1', 'John', '2023-01-01'),
    (2, 'Person 2', 'Alice', '2023-02-15'),
    (3, 'Person 3', 'Bob', '2023-03-10'),
    (4, 'Person 4', 'Emily', '2023-04-05'),
    (5, 'Person 5', 'Charlie', '2023-05-20'),
    (6, 'Person 6', 'Olivia', '2023-06-15'),
    (7, 'Person 7', 'Michael', '2023-07-01'),
    (8, 'Person 8', 'Sara', '2023-08-12'),
    (9, 'Person 9', 'David', '2023-09-25'),
    (10, 'Person 10', 'Emma', '2023-10-10');
